...
const EmployeeManagement = () => {
  ...
  const fetchEmployees = async () => {
    ...
    setError(null);
    try {
      const response = await fetch('http://weekend-production-4177.up.railway.app/api/admin/employees', {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const url = editingId
        ? `http://weekend-production-4177.up.railway.app/api/admin/employees/${editingId}`
        : 'http://weekend-production-4177.up.railway.app/api/admin/employees';
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`http://weekend-production-4177.up.railway.app/api/admin/employees/${id}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
