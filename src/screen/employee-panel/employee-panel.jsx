...
const EmployeePanel = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await fetch('http://weekend-production-4177.up.railway.app/api/admin/orders', {
        headers: {
  ...
  const handleUpdateStatus = async (orderId) => {
    try {
      const response = await fetch(`http://weekend-production-4177.up.railway.app/api/admin/orders/${orderId}/status`, {
        method: 'PATCH',
        headers: {
